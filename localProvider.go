...
func (l LocalCryptoProvider) DestroyCryptoContext(context types.CryptoContext) error {
	ctx := buildPathNameSpace(context)
...
func (l LocalCryptoProvider) IsCryptoContextExisting(context types.CryptoContext) (bool, error) {
	ctx := buildPathNameSpace(context)
	_, ok := namespaces[ctx]
	return ok, nil
}

func (l LocalCryptoProvider) GetNamespaces(context types.CryptoContext) ([]string, error) {
...
func (l LocalCryptoProvider) GetKey(parameter types.CryptoIdentifier) (*types.CryptoKey, error) {
...
func (l LocalCryptoProvider) IsKeyExisting(identifer types.CryptoIdentifier) (bool, error) {
...
func (l LocalCryptoProvider) GetKeys(parameter types.CryptoFilter) (*types.CryptoKeySet, error) {
	ctx := buildPathNameSpace(parameter.CryptoContext)
...
func (l LocalCryptoProvider) RotateKey(parameter types.CryptoIdentifier) error {
	return nil
}

func (l LocalCryptoProvider) Hash(parameter types.CryptoHashParameter, msg []byte) (b []byte, err error) {
...
func (l LocalCryptoProvider) GenerateRandom(context types.CryptoContext, number int) ([]byte, error) {
...
func (l LocalCryptoProvider) Encrypt(parameter types.CryptoIdentifier, data []byte) ([]byte, error) {
	ctx := buildPathNameSpace(parameter.CryptoContext)
...
func (l LocalCryptoProvider) Decrypt(parameter types.CryptoIdentifier, data []byte) ([]byte, error) {
	ctx := buildPathNameSpace(parameter.CryptoContext)
...
func (l LocalCryptoProvider) Sign(parameter types.CryptoIdentifier, data []byte) (b []byte, err error) {
	ctx := buildPathNameSpace(parameter.CryptoContext)
...
func (l LocalCryptoProvider) Verify(parameter types.CryptoIdentifier, data []byte, signature []byte) (b bool, err error) {
...
func (l LocalCryptoProvider) DeleteKey(parameter types.CryptoIdentifier) error {
...
func (l LocalCryptoProvider) GenerateKey(parameter types.CryptoKeyParameter) error {
...
func (l LocalCryptoProvider) GetSeed(context context.Context) string {
...
func (l LocalCryptoProvider) GetSupportedHashAlgs() []types.HashAlgorithm {
	return []types.HashAlgorithm{types.Sha2256}
}

func (l LocalCryptoProvider) GetSupportedKeysAlgs() []types.KeyType {
